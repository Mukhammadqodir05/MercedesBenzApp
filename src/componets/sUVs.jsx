...
import { SUVs_detail } from '/src/CarDetails.js';

const SUVs = () => {
  return (
    <main className="main bg2 flex justify-center items-center flex-col h-full p-3 pt-2 overflow-hidden ">
